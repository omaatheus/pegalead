...
export type LeadWhereInput = {
  ...
  identifier?: Prisma.StringFilter<"Lead"> | string
...
export type LeadScalarWhereWithAggregatesInput = {
  ...
  identifier?: Prisma.StringWithAggregatesFilter<"Lead"> | string
...
export type LeadUpdateselectedAnalyticsInput = {
  set?: string[]
  push?: string | string[]
}
...
export interface LeadDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const leadWithIdentifierOnly = await prisma.lead.findMany({ select: { identifier: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Leads and only return the `identifier`
   * const leadWithIdentifierOnly = await prisma.lead.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Leads and only return the `identifier`
   * const leadWithIdentifierOnly = await prisma.lead.updateManyAndReturn({
   *   select: { identifier: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface LeadFieldRefs {
  readonly identifier: Prisma.FieldRef<"Lead", 'String'>
