    ...
    return (
      <div className="flex flex-col gap-1.5 w-full group">
        ...
        <div className="relative rounded-md shadow-sm overflow-hidden">
          ...
          <span className={`absolute bottom-0 left-0 w-full h-[2px] transform scale-x-0 origin-left transition-transform duration-300 ease-out group-focus-within:scale-x-100 rounded-b-md pointer-events-none ${error ? 'bg-red-500' : 'bg-[#FACC15]'}`} />
        </div>
