export const env = {
    ...
    commandTokenEvent: process.env.NEXT_PUBLIC_COMMAND_TOKEN_EVENT || "",
    commandUrlEvent: process.env.NEXT_PUBLIC_COMMAND_URL_EVENT || "",
    columnIdEvent: process.env.NEXT_PUBLIC_COLUMN_ID_EVENT || "",
